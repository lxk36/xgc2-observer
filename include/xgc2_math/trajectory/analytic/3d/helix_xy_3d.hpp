...
struct HelixXyCurveParameters3 {
...
class HelixXyCurveEvaluator3 final : public TrajectoryEvaluator3 {
  public:
    explicit HelixXyCurveEvaluator3(const HelixXyCurveParameters3& params = {}) : params_(params) {
    ...
    const HelixXyCurveParameters3& params() const { return params_; }

  private:
    HelixXyCurveParameters3 params_;
};
